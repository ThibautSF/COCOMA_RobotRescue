package stss.qlearningproject.centralized;
...
public class CommandPickerPolice extends CommandPicker {
	...
	public CommandPickerPolice(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager,
			...
			if (agent != null && agent.getStandardURN() == StandardEntityURN.POLICE_FORCE) {
				...
				if (target != null) {
					if (target instanceof Area) {
						CommandPolice command = new CommandPolice(true, agentID, target.getID(),
